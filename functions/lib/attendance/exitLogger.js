...
async function createExitLog(confId, registrationId, zoneId, exitTime, isExternal = false, dryRun = false, zoneConfig) {
    ...
    try {
        return await getDb().runTransaction(async (transaction) => {
            ...
            const goalMinutes = (resolvedZoneConfig === null || resolvedZoneConfig === void 0 ? void 0 : resolvedZoneConfig.completionMode) === 'CUMULATIVE'
                ? (resolvedZoneConfig.cumulativeGoalMinutes || 0)
                : ((resolvedZoneConfig === null || resolvedZoneConfig === void 0 ? void 0 : resolvedZoneConfig.goalMinutes) || (resolvedZoneConfig === null || resolvedZoneConfig === void 0 ? void 0 : resolvedZoneConfig.globalGoalMinutes) || 0);
