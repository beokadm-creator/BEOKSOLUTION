...
async function diagnoseUserRegistration(userId, conferenceSlug = 'kadd_2026spring') {
    ...
    try {
        ...
        if (confSnap.exists) {
            ...
            console.log(`     title: ${JSON.stringify(data === null || data === void 0 ? void 0 : data.title)}`);
            console.log(`     societyId: ${data === null || data === void 0 ? void 0 : data.societyId}`);
            console.log(`     dates: ${JSON.stringify(data === null || data === void 0 ? void 0 : data.dates)}`);
        }
        else {
    ...
    try {
        ...
        if (userSnap.exists) {
            ...
            console.log(`     email: ${data === null || data === void 0 ? void 0 : data.email}`);
            console.log(`     phone: ${data === null || data === void 0 ? void 0 : data.phoneNumber}`);
            console.log(`     isAnonymous: ${(data === null || data === void 0 ? void 0 : data.isAnonymous) || false}`);
        }
        else {
