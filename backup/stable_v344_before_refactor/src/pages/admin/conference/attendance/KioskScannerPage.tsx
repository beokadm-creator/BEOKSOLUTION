...
const KioskScannerPage: React.FC = () => {
    ...
    // Save Design
    useEffect(() => {
        localStorage.setItem('kiosk_design', JSON.stringify(design));
    }, [design]);
        ...
        >
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center relative mt-16">
                ...
                <div className={`p-10 rounded-3xl w-full max-w-3xl shadow-2xl backdrop-blur-sm border transition-all duration-500 ${
                    ...
                    {/* Only show toggle buttons if NOT in Auto mode, and user might need to switch manually */}
                    {/* Actually, let's keep it clean. Top bar controls mode. 
                        We only show a large "Switch" button if we are in a strict mode to allow easy toggling by staff/users if allowed. 
                        Let's hide it for cleaner UI as per "Refine Logic". Top bar is sufficient for admins.
                    */}
...
export default KioskScannerPage;
