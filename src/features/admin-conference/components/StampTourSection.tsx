...
import {
    ...
    SponsorSummary,
    StampTourBoothOrderMode,
    StampTourRewardMode,
    StampTourDrawMode,
    StampTourRewardFulfillmentMode,
    StampTourRewardForm
} from '../types';
import { formatKstTimestamp } from '../hooks/useConferenceSettings';
import {
...
interface Props {
    ...
    setStampTourConfig: React.Dispatch<React.SetStateAction<StampTourConfigForm>>;
...
export function StampTourSection({
    cid,
    stampTourConfig,
    setStampTourConfig,
    stampTourProgress,
                    ...
                    <CardContent className="p-6 md:p-8 space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-xs text-slate-500 font-semibold">
                                완료: {stampTourProgress.filter(p => p.isCompleted).length}명
                            </div>
                        </div>
