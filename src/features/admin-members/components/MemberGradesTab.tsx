...
interface MemberGradesTabProps {
    grades: Grade[];
    newGradeName: string;
    setNewGradeName: (value: string) => void;
    newGradeCode: string;
    setNewGradeCode: (value: string) => void;
    handleAddGrade: () => void;
    handleDeleteGrade: (gradeCode: string) => void;
}

export function MemberGradesTab({
    grades,
    newGradeName,
    setNewGradeName,
    newGradeCode,
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-slate-500 font-medium mt-0.5">
                                Define member grades and codes (e.g., Regular, Associate). (v_fix_id)
                            </CardDescription>
                        </div>
                    </div>
                </CardHeader>
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl border border-dashed border-slate-200">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 items-end">
                            ...
                            <Button
                                ...
                                className="h-11 px-6 bg-slate-900 text-white w-full md:w-auto"
                            >
