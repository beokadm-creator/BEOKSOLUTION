...
interface MemberBulkUploadTabProps {
    bulkData: string;
    setBulkData: (value: string) => void;
    handleBulkUpload: () => void;
}

export function MemberBulkUploadTab({ bulkData, setBulkData, handleBulkUpload }: MemberBulkUploadTabProps) {
    return (
                ...
                <CardHeader className="bg-emerald-50/50 border-b border-emerald-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-emerald-600/80 font-medium mt-0.5">
                                회원 정보를 CSV 형식으로 대량 업로드합니다.
                            </CardDescription>
                        </div>
                    </div>
                </CardHeader>
                <CardContent className="p-8 space-y-6">
                    <div className="space-y-4">
                        ...
                        <Button
                            ...
                            size="lg"
                            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-200 rounded-xl h-12"
                        >
