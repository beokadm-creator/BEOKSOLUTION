...
import { onSnapshot, doc, DocumentData, Timestamp } from 'firebase/firestore';
                ...
                docUnsub = onSnapshot(userDocRef, (docSnap) => {
                    if (docSnap.exists()) {
                        ...
                        const userWithId: ConferenceUser = {
                            ...
                            phone: normalized.phone || '', // ✅ 통일된 필드
                            organization: normalized.organization || '', // ✅ 통일된 필드
                            licenseNumber: normalized.licenseNumber || '',
                            tier: normalized.tier || 'NON_MEMBER',
                            country: normalized.country || 'KR',
                            isForeigner: normalized.isForeigner || false,
