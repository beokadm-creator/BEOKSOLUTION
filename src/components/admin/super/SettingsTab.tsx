                    ...
                    <div className="flex justify-between items-start">
                        ...
                        <div className="bg-slate-100 p-1.5 rounded-xl flex gap-1">
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${settingsLang === 'KO' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                            >
                                <span className="text-lg">🇰🇷</span> KOREAN
                            </button>
                            <button
                                onClick={() => setSettingsLang('EN')}
                                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${settingsLang === 'EN' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                            >
