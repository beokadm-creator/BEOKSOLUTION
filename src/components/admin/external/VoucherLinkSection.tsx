...
import { collection, getDoc, getDocs, doc, query, where, orderBy, limit } from 'firebase/firestore';
import { db } from '../../../firebase';
import { Button } from '../../ui/button';
import { Loader2, CheckCircle2, MessageCircle, ExternalLink, AlertCircle, Copy } from 'lucide-react';
...
export const VoucherLinkSection: React.FC<VoucherLinkSectionProps> = ({
