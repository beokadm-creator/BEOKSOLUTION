...
import { Plus, Trash2, RefreshCw, Download, Info, Mail, MessageCircle, Save } from 'lucide-react';
import type { NotificationEventType, AlimTalkButton, TemplateVariable } from '@/types/schema';
import type { EVENT_TYPE_PRESETS } from '@/types/schema';

interface TemplateEditDialogProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    editingTemplate: import('@/types/schema').NotificationTemplate | null;
    ...
    onFetchNhnTemplates: () => Promise<void>;
    loadingNhn: boolean;
}
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0 gap-0 bg-white rounded-2xl overflow-hidden block">
                ...
                <DialogFooter className="p-6 border-t border-slate-100 bg-slate-50 sticky bottom-0 z-10">
                    ...
                    <Button onClick={onSave} className="bg-indigo-600 hover:bg-indigo-700 text-white min-w-[100px]">
