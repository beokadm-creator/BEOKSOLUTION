...
import { Loader2, AlertTriangle, ShieldCheck, CheckCircle2, X } from 'lucide-react';
import type { BulkModalState } from '@/hooks/useRegistrationList';

interface BulkSendModalProps {
    bulkModal: BulkModalState;
    setBulkModal: React.Dispatch<React.SetStateAction<BulkModalState>>;
    executeBulkSend: () => Promise<void>;
}

export const BulkSendModal: React.FC<BulkSendModalProps> = ({ bulkModal, setBulkModal, executeBulkSend }) => {
                    ...
                    {bulkModal.step === 'confirm' && (
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-xl">
                                ...
                                <p className="text-xs text-blue-700"><strong>안전:</strong> 화면을 닫아도 서버에서 멈춰지지 않고 처리됩니다.</p>
                            </div>
