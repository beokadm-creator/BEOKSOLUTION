...
interface ExtendedRegistration extends Registration {
    ...
    userOrg?: string;
    paymentKey?: string;
    paidAt?: Date | { toDate: () => Date } | string; // Handles Date, Timestamp, string
    orderId?: string;
    paymentType?: string;
    method?: string;
    userInfo?: {
        ...
        <div className="p-8 max-w-4xl mx-auto bg-white min-h-screen">
            ...
            <div className="grid grid-cols-2 gap-8 border p-6 rounded-lg">
                ...
                <div>
                    ...
                    <p className="text-lg">{data.licenseNumber || data.userInfo?.licenseNumber || data.userInfo?.licensenumber || '-'}</p>
                </div>
                <div>
