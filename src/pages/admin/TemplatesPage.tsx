                ...
                <TabsList className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 w-full h-auto p-1 bg-[#f0f5fa] rounded-xl gap-1">
                    {(Object.keys(eventPresets) as NotificationEventType[]).map(eventType => (
                        <TabsTrigger
                            key={eventType}
                            value={eventType}
                            className="text-xs md:text-sm py-2.5 rounded-lg font-bold data-[state=active]:bg-white data-[state=active]:text-[#003366] data-[state=active]:shadow-sm transition-all"
                        >
                ...
                {(Object.keys(eventPresets) as NotificationEventType[]).map(eventType => (
                    <TabsContent key={eventType} value={eventType} className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {eventPresets[eventType].variables.map(variable => (
                                        <button
                                            ...
                                            className="group flex items-center gap-2 px-3 py-2 bg-white border border-[#c3daee] rounded-xl text-sm text-slate-600 hover:bg-[#f0f5fa] hover:border-[#c3daee] hover:text-[#003366] hover:shadow-sm transition-all shadow-sm"
                                            title="Click to copy/insert"
                                        >
                                            <span className="font-mono font-bold text-[#003366] bg-[#f0f5fa] px-1.5 py-0.5 rounded">#{`{${variable.key}}`}</span>
                                            <span className="text-xs font-medium text-slate-500 group-hover:text-[#003366]">{variable.label}</span>
                                        </button>
                                    ))}
                                </div>
                            </CardContent>
                        ...
                        <div className="flex justify-between items-center pt-2">
                            ...
                            <Button onClick={handleCreate} className="bg-[#003366] hover:bg-[#002244] text-white shadow-md shadow-slate-200/50 rounded-xl">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0 gap-0 bg-white rounded-2xl overflow-hidden block">
                    ...
                    <div className="p-6 space-y-8">
                        ...
                        <section className="space-y-4">
                            <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wide flex items-center gap-2">
                                <span className="w-1 h-4 bg-[#003366] rounded-full" /> 기본 정보
                            </h4>
                            ...
                            <div className="bg-amber-50/30 border border-amber-100 p-5 rounded-xl space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4 order-1 md:order-2">
                                        ...
                                        <div className="bg-[#f0f5fa]/50 p-4 rounded-lg border border-[#c3daee]">
                                            <div className="flex items-center gap-2 mb-3">
                                                <Info className="w-3.5 h-3.5 text-[#003366]" />
                                                <span className="text-xs font-bold text-[#003366]">변수 간편 삽입</span>
                                            </div>
                                            <div className="flex flex-wrap gap-1.5">
                                                {currentVariables.map(variable => (
                                                    <button
                                                        key={variable.key}
                                                        onClick={() => insertVariable(variable.key)}
                                                        className="px-2 py-1 bg-white border border-[#c3daee] rounded text-[11px] font-mono text-[#003366] hover:bg-[#003366] hover:text-white transition-colors"
                                                        ...
                                                        <div className="md:col-span-9 space-y-1">
                                                            <div className="flex justify-between items-center">
                                                                ...
                                                                <Select onValueChange={v => handleSmartLinkPreset(idx, v)}>
                                                                    <SelectTrigger className="h-6 text-[10px] w-auto border-none bg-transparent shadow-none p-0 text-[#003366] hover:text-[#002244] font-medium">
                    ...
                    <DialogFooter className="p-6 border-t border-slate-100 bg-slate-50 sticky bottom-0 z-10">
                        ...
                        <Button onClick={handleSave} className="bg-[#003366] hover:bg-[#002244] text-white min-w-[100px]">
